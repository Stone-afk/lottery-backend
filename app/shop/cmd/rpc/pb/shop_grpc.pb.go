...
func (c *shopClient) GetGoodsById(ctx context.Context, in *GoodsReq, opts ...grpc.CallOption) (*GoodsResp, error) {
	out := new(GoodsResp)
	err := c.cc.Invoke(ctx, "/stream.Shop/getGoodsById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shopClient) GetGoodsList(ctx context.Context, in *GoodsListReq, opts ...grpc.CallOption) (*GoodsListResp, error) {
	...
	err := c.cc.Invoke(ctx, "/stream.Shop/getGoodsList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Shop_GetGoodsById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stream.Shop/getGoodsById",
	}
...
func _Shop_GetGoodsList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/stream.Shop/getGoodsList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
